...
**Microsoft director: AI scraping 'the largest theft of labor in human history'**——这条来自 Hacker News 的 AI 动态，正文总结正在自动生成中。

## 核心要点

1. **Microsoft director: AI scraping 'the largest theft of labor in human history'**——这条来自 Hacker News 的 AI 动态，正文总结正在自动生成中
...
这条动态来自 **Hacker News**，属于「社区」方向。保持对这类消息的关注，能帮你判断哪些 AI 能力已经可用、哪些还只是宣传。
...
- 来源：Hacker News
- 发布日期：2026-09-20
- 原始链接（纯文本，不可点击）：`https://www.tomshardware.com/tech-industry/artificial-intelligence/microsoft-director-called-ai-scraping-the-largest-theft-of-labor-in-human-history-while-openai-head-brands-chatgpt-an-existential-threat-to-publishers-revelations-come-from-legal-briefs-filed-in-nyt-lawsuit`
