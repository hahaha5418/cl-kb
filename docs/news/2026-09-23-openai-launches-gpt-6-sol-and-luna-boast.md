...
**OpenAI launches GPT-6 Sol and Luna, boasting lower cost and fewer mistakes**——这条来自 TechCrunch AI 的 AI 动态，正文总结正在自动生成中。

## 核心要点

1. **OpenAI launches GPT-6 Sol and Luna, boasting lower cost and fewer mistakes**——这条来自 TechCrunch AI 的 AI 动态，正文总结正在自动生成中
...
- 原标题：**OpenAI** launches **GPT**-6 Sol and Luna, boasting lower cost and fewer mistakes
- 来源：TechCrunch AI
- 发布日期：2026-09-23
- 原始链接（纯文本，不可点击）：`https://techcrunch.com/2026/09/22/openai-launches-gpt-6-sol-and-luna/`
