...
**Early rogue AI agent activity and attempts to hack found on urlquery.net**——这条来自 Hacker News 的 AI 动态，正文总结正在自动生成中。

## 核心要点

1. **Early rogue AI agent activity and attempts to hack found on urlquery.net**——这条来自 Hacker News 的 AI 动态，正文总结正在自动生成中
...
- 来源：Hacker News
- 发布日期：2026-09-24
- 原始链接（纯文本，不可点击）：`https://transluce.org/agent-activity`
