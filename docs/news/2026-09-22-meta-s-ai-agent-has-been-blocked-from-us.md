...
**Meta’s AI agent has been blocked from using Amazon.com**——这条来自 TechCrunch AI 的 AI 动态，正文总结正在自动生成中。

## 核心要点

1. **Meta’s AI agent has been blocked from using Amazon.com**——这条来自 TechCrunch AI 的 AI 动态，正文总结正在自动生成中
...
- 原标题：**Meta**’s AI agent has been blocked from using **Amazon**.com
- 来源：TechCrunch AI
- 发布日期：2026-09-22
- 原始链接（纯文本，不可点击）：`https://techcrunch.com/2026/09/21/metas-ai-agent-has-been-blocked-from-using-amazon-com/`
